...
const COLLAPSE_KEY = "helixblog_sidebar_collapsed";
...
export default function AppShell() {
  ...
  const leftCol = collapsed ? "64px" : "240px";

  return (
    <div className="min-h-screen bg-background">
      <div
        className="max-w-7xl mx-auto grid min-h-screen grid-cols-1 md:grid-cols-[var(--left-col)_1fr] lg:grid-cols-[var(--left-col)_1fr_300px] xl:grid-cols-[var(--left-col)_1fr_320px]"
        style={{ "--left-col": leftCol }}
      >
        ...
        {/* Main Feed */}
        <main id="feed-scroll" className="border-x border-border min-h-screen pb-16 md:pb-0 min-w-0">
          <Outlet />
        </main>
